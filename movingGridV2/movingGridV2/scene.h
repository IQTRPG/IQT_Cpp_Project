...
void scene(char left, char center, char right, char LR, char CR, char RR, char L, char R)
{
	...
	else if (left == 'W' && center == 'W' && right == 'W' && LR == 'X' && CR == 'X' && RR == 'X' && L == 'W' && R == 'W')  // Close?
	{
	...
	// new close to wall
	else if (left == 'W' && center == 'W' && right == 'W' && LR == 'X' && CR == 'X' && RR == 'X' && L == 'W' && R == 'O') {  // Close?
		std::cout << "|||||||||||||||._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._" << std::endl;
		std::cout << "|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||" << std::endl;
		std::cout << "|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||" << std::endl;
		std::cout << "|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||" << std::endl;
	...
	else if (left == 'W' && center == 'W' && right == 'W' && LR == 'X' && CR == 'X' && RR == 'X' && L == 'O' && R == 'W')  // Close?
	{
		std::cout << "._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'._'||||||||||||||" << std::endl;
		std::cout << "|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||" << std::endl;
		std::cout << "|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||" << std::endl;
